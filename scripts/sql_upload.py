...
def player_table(engine):
    ...
    try:
        table = pd.read_sql_query(
            "SELECT * FROM FantasySidelines.dbo.playerStats", engine
        )

        player_table_df = table[
            [
                "player.id",
                "player.name",
                "player.position",
        ...
        player_table_df = player_table_df.groupby(
            ["player.id", "player.name", "player.sr_id"]
        )[
            [
                "player.position",
                "player.jersey_num",
        ...
        player_table_df["player.position"] = player_table_df["player.position"].apply(
            lambda x: ", ".join(map(str, x))
        )
        player_table_df["player.jersey_num"] = player_table_df[
            "player.jersey_num"
        ].apply(lambda x: ", ".join(map(str, x)))
        player_table_df["team.alias"] = player_table_df["team.alias"].apply(
            lambda x: ", ".join(map(str, x))
        )
        player_table_df["team.name"] = player_table_df["team.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        player_table_df["team.id"] = player_table_df["team.id"].apply(
            lambda x: ", ".join(map(str, x))
        )

        player_table_df.to_sql(
            "IDPlayerTable",
            engine,
            if_exists="replace",
            index=False,
...
def game_table(engine):
    ...
    try:
        ...
        game_id_df["game.status"] = game_id_df["game.status"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.reference"] = game_id_df["game.reference"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.number"] = game_id_df["game.number"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.scheduled"] = game_id_df["game.scheduled"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.attendance"] = game_id_df["game.attendance"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.utc_offset"] = game_id_df["game.utc_offset"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.entry_mode"] = game_id_df["game.entry_mode"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.sr_id"] = game_id_df["game.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["game.broadcast.internet"] = game_id_df[
            "game.broadcast.internet"
        ].apply(lambda x: ", ".join(map(str, x)))
        game_id_df["game.broadcast.network"] = game_id_df[
            "game.broadcast.network"
        ].apply(lambda x: ", ".join(map(str, x)))
        game_id_df["venue.id"] = game_id_df["venue.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.name"] = game_id_df["venue.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.city"] = game_id_df["venue.city"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.state"] = game_id_df["venue.state"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.country"] = game_id_df["venue.country"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.zip"] = game_id_df["venue.zip"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.address"] = game_id_df["venue.address"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.capacity"] = game_id_df["venue.capacity"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.surface"] = game_id_df["venue.surface"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.roof_type"] = game_id_df["venue.roof_type"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.sr_id"] = game_id_df["venue.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.location.lat"] = game_id_df["venue.location.lat"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["venue.location.lng"] = game_id_df["venue.location.lng"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["team.id"] = game_id_df["team.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["team.name"] = game_id_df["team.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["team.alias"] = game_id_df["team.alias"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["team.game_number"] = game_id_df["team.game_number"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["team.sr_id"] = game_id_df["team.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["opp.id"] = game_id_df["opp.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["opp.name"] = game_id_df["opp.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["opp.alias"] = game_id_df["opp.alias"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["opp.game_number"] = game_id_df["opp.game_number"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["opp.sr_id"] = game_id_df["opp.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["season.id"] = game_id_df["season.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["season.year"] = game_id_df["season.year"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["season.name"] = game_id_df["season.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["season.type"] = game_id_df["season.type"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["week.id"] = game_id_df["week.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["week.sequence"] = game_id_df["week.sequence"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df["week.title"] = game_id_df["week.title"].apply(
            lambda x: ", ".join(map(str, x))
        )
        game_id_df[
            [
...
def season_table(engine):
    ...
    try:
        ...
        season_id_df["season.year"] = season_id_df["season.year"].apply(
            lambda x: ", ".join(map(str, x))
        )
        season_id_df["season.type"] = season_id_df["season.type"].apply(
            lambda x: ", ".join(map(str, x))
        )
        season_id_df["season.name"] = season_id_df["season.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
...
def week_table(engine):
    ...
    try:
        ...
        week_id_df["week.sequence"] = week_id_df["week.sequence"].apply(
            lambda x: ", ".join(map(str, x))
        )
        week_id_df["week.title"] = week_id_df["week.title"].apply(
            lambda x: ", ".join(map(str, x))
        )
        week_id_df["season.id"] = week_id_df["season.id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        week_id_df["season.year"] = week_id_df["season.year"].apply(
            lambda x: ", ".join(map(str, x))
        )
        week_id_df["season.type"] = week_id_df["season.type"].apply(
            lambda x: ", ".join(map(str, x))
        )
        week_id_df[["week.sequence", "season.year"]] = week_id_df[
            ["week.sequence", "season.year"]
        ].astype(int)
...
def team_table(engine):
    ...
    try:
        ...
        team_id_df["team.name"] = team_id_df["team.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        team_id_df["team.market"] = team_id_df["team.market"].apply(
            lambda x: ", ".join(map(str, x))
        )
        team_id_df["team.alias"] = team_id_df["team.alias"].apply(
            lambda x: ", ".join(map(str, x))
        )
        team_id_df["team.sr_id"] = team_id_df["team.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
...
def venue_table(engine):
    ...
    try:
        ...
        venue_id_df["venue.name"] = venue_id_df["venue.name"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.city"] = venue_id_df["venue.city"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.state"] = venue_id_df["venue.state"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.country"] = venue_id_df["venue.country"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.zip"] = venue_id_df["venue.zip"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.address"] = venue_id_df["venue.address"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.capacity"] = venue_id_df["venue.capacity"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.surface"] = venue_id_df["venue.surface"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.roof_type"] = venue_id_df["venue.roof_type"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.sr_id"] = venue_id_df["venue.sr_id"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.location.lat"] = venue_id_df["venue.location.lat"].apply(
            lambda x: ", ".join(map(str, x))
        )
        venue_id_df["venue.location.lng"] = venue_id_df["venue.location.lng"].apply(
            lambda x: ", ".join(map(str, x))
        )
...
def calendar_table(start_date, end_date, engine):
    ...
    try:
        ...
        calendar_df = pd.DataFrame(
            pd.date_range(start_date, end_date, freq="H", normalize=True),
            columns=["date"],
        )
...
def weekly_stats_offense(conn, engine):
    ...
    try:
        ...
        player_snaps["player_name"] = player_snaps["player_name"].str.replace(
            "|".join([re.escape(s) for s in replace]), "", regex=True
        )
        player_practice["player.name"] = player_practice["player.name"].str.replace(
            "|".join([re.escape(s) for s in replace]), "", regex=True
        )
        ...
        weekly_stats["team.alias"] = weekly_stats["team.alias"].fillna(
            weekly_stats["game.team.alias"]
        )
        weekly_stats["team.id"] = weekly_stats["team.id"].fillna(
            weekly_stats["game.team.id"]
        )
        weekly_stats["opp.alias"] = weekly_stats["opp.alias"].fillna(
            weekly_stats["game.opp.alias"]
        )
        weekly_stats["opp.id"] = weekly_stats["opp.id"].fillna(
            weekly_stats["game.opp.id"]
        )
        weekly_stats["game.id"] = weekly_stats["game.id"].fillna(
            weekly_stats["game.id.merged"]
        )
        weekly_stats["season.year"] = weekly_stats["season.year"].fillna(
            weekly_stats["season.year.merged"]
        )
        weekly_stats["week.sequence"] = weekly_stats["week.sequence"].fillna(
            weekly_stats["week.sequence.merged"]
        )
        ...
        weekly_stats["player.jersey_num"] = weekly_stats["player.jersey_num"].astype(
            str
        )
        ...
        weekly_stats[["week.id"]] = weekly_stats.groupby(
            ["season.id", "week.sequence"]
        )[["week.id"]].apply(lambda x: x.ffill().bfill())
        ...
        weekly_stats[
            ["game.id", "opp.alias", "opp.id", "opp.name"]
        ] = weekly_stats.groupby(["season.id", "week.id", "team.id"])[
            ["game.id", "opp.alias", "opp.id", "opp.name"]
        ].apply(
        ...
        weekly_stats[
            ["player.id", "player.sr_id", "player.jersey_num", "player.address"]
        ] = weekly_stats.groupby(["player.name", "season.id", "team.id"])[
            ["player.id", "player.sr_id", "player.jersey_num", "player.address"]
        ].apply(
            lambda x: x.ffill().bfill()
        )
        ...
        ] = weekly_stats.groupby(["player.id", "week.id"])[
            [
                "home.away",
                "game.scheduled",
                "off.snaps",
        ...
        weekly_stats["game.scheduled"] = weekly_stats.groupby("game.id")[
            "game.scheduled"
        ].apply(lambda x: x.ffill().bfill())
        ...
        weekly_stats["player.position"] = weekly_stats.groupby("player.name")[
            "player.position"
        ].apply(lambda x: x.ffill().bfill())

        weekly_stats = weekly_stats[weekly_stats["player.id"].notna()]

        weekly_stats["total.snaps"] = weekly_stats["off.snaps"].add(
            weekly_stats["st.snaps"], fill_value=0
        )
        ...
        weekly_stats[stat_columns[:-1]] = weekly_stats.groupby(id_columns[:-8])[
            stat_columns[:-1]
        ].apply(lambda x: x.ffill().bfill())
        ...
        weekly_stats.sort_values(
            ["player.name", "season.year", "week.sequence", "stats.sum"], inplace=True
        )
        weekly_stats.drop_duplicates(
            subset=["player.id", "week.id"], keep="last", inplace=True
        )
        weekly_stats = weekly_stats[
            (weekly_stats["stats.sum"] != 0)
            | (weekly_stats["total.snaps"] > 0)
            | ~(weekly_stats["injury"].isnull())
        ]

        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "concussion|head", case=False, na=False, regex=True
            ),
            "head",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "neck|throat|cervical|sternoclavi", case=False, na=False, regex=True
            ),
            "neck",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "shoulder|collarbone|clavicle", case=False, na=False, regex=True
            ),
            "shoulder",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "bicep|tricep", case=False, na=False, regex=True
            ),
            "upper_arm",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "elbow", case=False, na=False, regex=True
            ),
            "elbow",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "forearm|radius|ulna", case=False, na=False, regex=True
            ),
            "forearm",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "wrist|carpal", case=False, na=False, regex=True
            ),
            "wrist",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "hand|finger", case=False, na=False, regex=True
            ),
            "hand_finger",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "thumb", case=False, na=False, regex=True
            ),
            "thumb",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "back|lumbar", case=False, na=False, regex=True
            ),
            "back",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "chest|pec|sternum|rib", case=False, na=False, regex=True
            ),
            "chest",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "core|appendix|oblique|abdomen", case=False, na=False, regex=True
            ),
            "abdomen",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "hip|groin|glute|pelvis", case=False, na=False, regex=True
            ),
            "hip",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "groin", case=False, na=False, regex=True
            ),
            "groin",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "quad", case=False, na=False, regex=True
            ),
            "quadricep",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "hamstring", case=False, na=False, regex=True
            ),
            "hamstring",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "thigh|quad|hams", case=False, na=False, regex=True
            ),
            "thigh",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "knee|acl|mcl|lcl", case=False, na=False, regex=True
            ),
            "knee",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "achil", case=False, na=False, regex=True
            ),
            "achilles",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "ankle", case=False, na=False, regex=True
            ),
            "ankle",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "foot|heel", case=False, na=False, regex=True
            ),
            "foot",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "toe", case=False, na=False, regex=True
            ),
            "toe",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "non football", case=False, na=False, regex=True
            ),
            "non_football",
        ] = 1
        ...
        weekly_stats.loc[
            weekly_stats["injury"].str.contains(
                "ill|stomach", case=False, na=False, regex=True
            ),
            "illness",
        ] = 1
        ...
        played_mask = (
            (weekly_stats["total.snaps"].notna()) & (weekly_stats["total.snaps"] > 0)
        ) & ((weekly_stats["stats.sum"].notna()) & (weekly_stats["stats.sum"] != 0))
        ...
        weekly_stats["game.scheduled"] = pd.to_datetime(
            weekly_stats["game.scheduled"], format="%Y-%m-%d %H:%M"
        )
